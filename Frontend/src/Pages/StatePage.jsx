...
function StatePage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch(`https://anaudip-etp.onrender.com/api/state/${stateName}/centers`);
  ...
  const handleExport = async (type) => {
    try {
      window.open(`https://anaudip-etp.onrender.com/api/state/${stateName}/centers?exportType=${type}`, '_blank');
    } catch (error) {
